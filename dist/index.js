...
function log() {
    ...
    console.log.apply(console, __spreadArray(["LME Torrent manager"], args, false));
}
...
var TransmissionRpcClient = /** @class */ (function () {
    function TransmissionRpcClient(url, login, password, sessionId) {
        this.url = url;
        this.login = login;
        this.password = password;
        this.sessionId = sessionId;
    }
    TransmissionRpcClient.prototype.fetchRpc = function (request) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.url, {
                            method: 'POST',
                            headers: {
                                'Authorization': "Basic ".concat(btoa(this.login + ':' + this.password)),
                    ...
                    case 1:
                        ...
                        if (response.status === 409) {
                            ...
                            return [2 /*return*/, this.fetchRpc(request)];
                        }
                        if (!response.ok) {
    ...
    TransmissionRpcClient.prototype.getSession = function () {
        var request = {
            method: 'session-get',
        };
        return this.fetchRpc(request);
    };
    TransmissionRpcClient.prototype.addTorrent = function (args) {
        var request = {
            method: 'torrent-add',
            arguments: args,
        };
    ...
    TransmissionRpcClient.prototype.getTorrents = function (args) {
        var request = {
            method: 'torrent-get',
            arguments: args,
        };
    ...
    TransmissionRpcClient.prototype.startTorrent = function (args) {
        var request = {
    ...
    TransmissionRpcClient.prototype.stopTorrent = function (args) {
        var request = {
            method: 'torrent-stop',
            arguments: args,
        };
    ...
    TransmissionRpcClient.prototype.setTorrent = function (args) {
        var request = {
            method: 'torrent-set',
            arguments: args,
        };
...
var url = Lampa.Storage.field('lmetorrenttransmissionUrl');
var user = Lampa.Storage.field('lmetorrenttransmissionUser');
var pass = Lampa.Storage.field('lmetorrenttransmissionPass');
...
function getSessionId() {
    return Lampa.Storage.get('lmetorrenttransmissionKey');
}
function getHeaders() {
    var headers = {
...
var Transmission = /** @class */ (function () {
    ...
    Transmission.auth = function () {
        var req = {
            url: "".concat(proxy).concat(url).concat(path),
            method: 'POST',
            headers: getHeaders(),
    ...
    Transmission.GetData = function () {
        ...
        return new Promise(function (resolve, reject) {
            $.ajax(settings)
                ...
                try {
                    var standardizedResponse = response.arguments.torrents.map(function (torrent) { return ({
                        name: torrent.name,
                        id: torrent.id,
    ...
    Transmission.getId = function (labels) {
        var _a;
        var id = ((_a = labels.find(function (label) { return label.startsWith('tmdbId:'); })) === null || _a === void 0 ? void 0 : _a.split(':')[1]) || '';
        return parseInt(id);
    };
    Transmission.GetTorrents = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        client = new TransmissionRpcClient("".concat(proxy).concat(url).concat(path), user, pass, getSessionId());
                        response = client.getTorrents({ fields: ['id', 'name', 'status', 'percentDone', 'totalSize', 'labels'] });
                        return [4 /*yield*/, response];
                    case 1: return [2 /*return*/, ((_a = (_b.sent()).arguments) === null || _a === void 0 ? void 0 : _a.torrents.map(function (torrent) { return ({
                            id: Transmission.getId(torrent.labels),
                            name: torrent.name,
                            status: torrent.status,
                            percentDone: torrent.percentDone,
                            totalSize: torrent.totalSize,
                        }); }).filter(function (torrent) { return torrent.id; })) || []];
                }
            });
        });
    };
    Transmission.SendCommand = function (btn, torrent_data) {
        var method;
    ...
    Transmission.SendTask = function (selectedTorrent) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var tmdbId, client, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!selectedTorrent) {
                        ...
                        tmdbId = new URLSearchParams(window.location.search).get("card");
                        client = new TransmissionRpcClient("".concat(proxy).concat(url).concat(path), user, pass, getSessionId());
                        return [4 /*yield*/, client.addTorrent({
                                paused: true,
                    ...
                    case 1:
                        response = _b.sent();
                        if (!((_a = response.arguments) === null || _a === void 0 ? void 0 : _a['torrent-added'])) return [3 /*break*/, 3];
                        return [4 /*yield*/, client.setTorrent({
    ...
    Transmission.POST = function (method, args) {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(proxy).concat(url).concat(path), {
                            method: 'POST',
                            headers: getHeaders(),
                            body: JSON.stringify({
                                method: method,
...
var BackgroundWorker = /** @class */ (function () {
    function BackgroundWorker(interval) {
        var _this = this;
        // setInterval(() => this.updateData(), interval);
        setInterval(function () { return _this.addProgressBars(); }, interval);
    }
    BackgroundWorker.start = function (interval) {
        if (!BackgroundWorker.instance) {
            BackgroundWorker.instance = new BackgroundWorker(interval);
        }
    };
    BackgroundWorker.prototype.updateData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data, updatedData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getTransmissionData()];
                    case 1:
                        data = _a.sent();
                        return [4 /*yield*/, this.updateMovieInfo(data)];
                    case 2:
                        updatedData = _a.sent();
                        return [4 /*yield*/, this.saveData(updatedData)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BackgroundWorker.prototype.getTransmissionData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data, existingData_1, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Transmission.GetTorrents()];
                    case 1:
                        data = _a.sent();
                        existingData_1 = Lampa.Storage.get('transmissionData') || [];
                        return [2 /*return*/, data.map(function (newItem) {
                                var existingItem = existingData_1.find(function (item) { return item.id === newItem.id; });
                                return existingItem ? __assign(__assign({}, existingItem), newItem) : newItem;
                            })];
                    case 2:
                        error_1 = _a.sent();
                        log('Error fetching transmission data:', error_1);
                        return [2 /*return*/, []];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    BackgroundWorker.prototype.updateMovieInfo = function (source) {
        return __awaiter(this, void 0, void 0, function () {
            var movieToUpdate_1, url_1;
            return __generator(this, function (_a) {
                try {
                    movieToUpdate_1 = source.find(function (movie) { return !movie.title; });
                    if (movieToUpdate_1) {
                        url_1 = "https://api.themoviedb.org/3/movie/".concat(movieToUpdate_1.id, "?api_key=4ef0d7355d9ffb5151e987764708ce96&language=ru");
                        network.silent(url_1, function (movieItem) {
                            if (movieItem) {
                                var index = source.findIndex(function (movie) { return movie.id === movieToUpdate_1.id; });
                                source[index] = __assign(__assign({}, source[index]), movieItem);
                            }
                            else {
                                log('No result found for ' + movieToUpdate_1.name, movieToUpdate_1);
                            }
                        });
                    }
    ...
    BackgroundWorker.prototype.saveData = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
    ...
    BackgroundWorker.prototype.addProgressBars = function () {
        return __awaiter(this, void 0, void 0, function () {
            var storedData, matchedMovies;
            return __generator(this, function (_a) {
                storedData = Lampa.Storage.get('transmissionData') || [];
                matchedMovies = [];
                log('Starting to add progress bars');
                $('.card').each(function () {
                    var title = $(this).find('.card__title').text().trim();
                    var releaseYear = $(this).find('.card__age').text().trim();
                    var matchingMovie = storedData.find(function (movie) {
                        var movieReleaseYear = movie.release_date ? new Date(movie.release_date).getFullYear().toString() : movie.release_year;
...
(function () {
    ...
    function _regeneratorRuntime() {
        ...
        var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty ||
            function (t, e, r) {
                t[e] = r.value;
            ...
            function invoke(r, o, i, a) {
                ...
                if ("throw" !== c.type) {
                    ...
                    return h && "object" == typeof h && n.call(h, "__await")
                        ? e.resolve(h.__await).then(function (t) {
                            invoke("next", t, i, a);
                        }, function (t) {
                            invoke("throw", t, i, a);
                        })
            ...
            if (o === t)
                return ((r.delegate = null),
                    ("throw" === n &&
                        ...
                        ("return" !== n &&
                            ((r.method = "throw"),
                                (r.arg = new TypeError("The iterator does not provide a '" +
                                    n +
                                    "' method")))),
                    y);
    ...
    function getHeaders$2(type) {
        ...
        if (Lampa.Storage.get("lmetorrentqBittorentKey"))
            headers["set-cookie"] = Lampa.Storage.get("lmetorrenttransmissionKey");
        if (Lampa.Storage.field("lmetorrentqBittorentProxy") === true)
            headers["x-requested-with"] = "lampame";
        return headers;
    }
                ...
                try {
                    var standardizedResponse = response.map(function (torrent) {
                        return {
                            ...
                            id: torrent.hash,
                            size: torrent.size,
                            state: torrent.state.charAt(0).toUpperCase() +
                                torrent.state.slice(1),
    ...
    function SendTask$2(selectedTorrent) {
        ...
        var settings = {
            ...
            headers: getHeaders$2("application/x-www-form-urlencoded"),
            data: {
                urls: selectedTorrent.MagnetUri
                    ? selectedTorrent.MagnetUri
                    : selectedTorrent.Link,
                category: selectedTorrent.CategoryDesc
                    ? Lampa.Storage.get("lmetorrentqBittorent".concat(selectedTorrent.CategoryDesc))
                    : "",
                firstLastPiecePrio: Lampa.Storage.field("lmetorrentqBittorentfirstLastPiecePrio")
                    ? "true"
                    : "false",
                sequentialDownload: Lampa.Storage.field("lmetorrentqBittorentSequentialDownload")
                    ? "true"
                    : "false",
            },
        };
    ...
    function auth() {
        $.ajax({
            url: ""
                .concat(proxy)
                .concat(url, "/webapi/auth.cgi?api=SYNO.API.Auth&method=login&account=")
                .concat(user, "&passwd=")
                .concat(pass, "&format=sid&version=7&session=LMETorrentManager"),
            method: "GET",
            headers: getHeaders(),
    ...
    function GetData() {
        var settings = {
            url: ""
                .concat(proxy)
                .concat(url, "/webapi/DownloadStation/task.cgi?api=SYNO.DownloadStation.Task&version=3&method=list&additional=file,transfer&_sid=")
                .concat(Lampa.Storage.field("lmetorrentsynologyKey").sID, "&limit=-1"),
            method: "GET",
            timeout: 0,
                ...
                try {
                    var standardizedResponse = response.data.tasks.map(function (torrent) {
                        return {
                            ...
                            id: torrent.id,
                            size: torrent.size,
                            state: torrent.status.charAt(0).toUpperCase() +
                                torrent.status.slice(1),
                            completed: torrent.additional.transfer
                                .size_downloaded / torrent.size, // или другой соответствующий атрибут
                        };
                    });
                    resolve(standardizedResponse);
                }
    ...
    function SendCommand(a, torrent_data) {
        var settings = {
            url: ""
                .concat(proxy)
                .concat(url, "/webapi/DownloadStation/task.cgi?api=SYNO.DownloadStation.Task&version=1&method=")
                .concat(a.action, "&id=")
                .concat(torrent_data.id, "&_sid=")
                .concat(Lampa.Storage.field("lmetorrentsynologyKey").sID),
            method: "GET",
            timeout: 0,
            headers: getHeaders(), // Если getHeaders возвращает объект с ключом headers
        };
    ...
    function SendTask(selectedTorrent) {
        var path = selectedTorrent.CategoryDesc
            ? "&destination=".concat(Lampa.Storage.get("lmetorrentsynologyPath".concat(selectedTorrent.CategoryDesc)))
            : "";
        var settings = {
            url: ""
                .concat(proxy)
                .concat(url, "/webapi/DownloadStation/task.cgi?api=SYNO.DownloadStation.Task&version=1&method=create&uri=")
                .concat(encodeURIComponent(selectedTorrent.MagnetUri
                ? selectedTorrent.MagnetUri
                : selectedTorrent.Link))
                .concat(path, "&_sid=")
                .concat(Lampa.Storage.field("lmetorrentsynologyKey").sID),
    ...
    function Item(data) {
        ...
        var itemN = Lampa.Template.get("lmetorrent_item__card", {
            ...
            completed: Number((data.completed * 100).toFixed(2)) + "%",
            quality: data.name.match(regexp2)
                ? data.name
                    .match(regexp2)
                    .toString()
                    .replace(/[ .()]/g, "")
    ...
    function Component() {
        ...
        var active, last;
        this.create = /*#__PURE__*/ _asyncToGenerator(
                    ...
                    switch ((_context2.prev = _context2.next)) {
                        case 0:
                            _startClient = function _startClient3() {
                                ...
                                /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(client) {
                                            ...
                                            switch ((_context.prev =
                                                ...
                                                case 5:
                                                    _yield$Promise$all =
                                                        _context.sent;
                                                    _yield$Promise$all2 =
                                                        _slicedToArray(_yield$Promise$all, 2);
                                                    qbData =
                                                ...
                                                case 12:
                                                    _yield$Promise$all3 =
                                                        _context.sent;
                                                    _yield$Promise$all4 =
                                                        _slicedToArray(_yield$Promise$all3, 2);
                                                    trData =
                                                        _yield$Promise$all4[0];
                                                    trInfo =
        ...
        this.errorClient = function (data) {
            ...
            var error_body = '<div class="lmetorrent-error_body">\n            <div>'
                .concat(Lampa.Lang.translate("somethingWentWrong"), '</div>\n            <div class="lmetorrent-error_result">')
                .concat(Lampa.Lang.translate("clientNotClient"), "</div>");
    ...
    function Main$1(manifest) {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onRender: function onRender(item) {
                if (Lampa.Storage.field(manifest.component + "Select") ===
                    "universalClient") {
                    item.show();
                }
                else
        ...
        Lampa.SettingsApi.addParam({
            ...
            onRender: function onRender(item) {
                if (Lampa.Storage.field(manifest.component + "Select") ===
                    "qBittorent" &&
                    Lampa.Storage.field(manifest.component + "qBittorentTweak") === true) {
                    item.show();
                }
                else
                    item.hide();
        ...
        Lampa.SettingsApi.addParam({
            ...
            onRender: function onRender(item) {
                if (Lampa.Storage.field(manifest.component + "Select") ===
                    "transmission" &&
                    Lampa.Storage.field(manifest.component + "transmissionTweak") === true) {
                    item.show();
                }
                else
                    item.hide();
    ...
    function Main(selectedTorrent) {
        if (Lampa.Storage.field("lmetorrentUniversalAction") === "open") {
            ...
            Lampa.Utils.copyTextToClipboard(selectedTorrent.MagnetUri
                ? selectedTorrent.MagnetUri
                : selectedTorrent.Link, function () {
    ...
    function Send() {
        ...
        Lampa.Listener.follow("torrent", function (e) {
            if (e.type === "onlong") {
                ...
                //Universal
                if (Lampa.Storage.field("lmetorrentSelect") ===
                    "universalClient") {
                    e.menu.push({
                        title: '<div class="btnTDdownload wait">\n                            <svg class="btnTDdownload" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M8.5 7L8.5 14M8.5 14L11 11M8.5 14L6 11" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M15.5 7L15.5 14M15.5 14L18 11M15.5 14L13 11" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M18 17H12H6" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="#ffffff" stroke-width="1.5"></path> </g></svg>\n                            Universal</div>',
    ...
    function add() {
        ...
        if (Lampa.Storage.get(manifest.component + "Select") !==
            "universalClient")
        ...
        if (Lampa.Storage.get(manifest.component + "Select") === "transmission")
            Transmission.auth();
        // Start Synology Auth */
