"use strict";(()=>{var xe=Object.defineProperty,De=Object.defineProperties;var Ce=Object.getOwnPropertyDescriptors;var V=Object.getOwnPropertySymbols;var Ae=Object.prototype.hasOwnProperty,Ee=Object.prototype.propertyIsEnumerable;var H=(a,e,t)=>e in a?xe(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,D=(a,e)=>{for(var t in e||(e={}))Ae.call(e,t)&&H(a,t,e[t]);if(V)for(var t of V(e))Ee.call(e,t)&&H(a,t,e[t]);return a},C=(a,e)=>De(a,Ce(e));var r=(a,e,t)=>new Promise((o,n)=>{var s=u=>{try{p(t.next(u))}catch(R){n(R)}},c=u=>{try{p(t.throw(u))}catch(R){n(R)}},p=u=>u.done?o(u.value):Promise.resolve(u.value).then(s,c);p((t=t.apply(a,e)).next())});var _=`<svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="4 4 16 16">\r
...
.download-card__stats .eta {
  ...
  right: 0;
  font-size: inherit;
}`;function b(...a){console.log(i.name,...a)}function X(...a){console.warn(i.name,...a)}var ee=i.component+".movieinfo.data.v4",h=class{static getMovieInfo(e){if(!e.id)return null;let t=`${e.type}_${e.id}`;return this.memoryCache[t]?this.memoryCache[t]:(this.requestedIds.has(t)||(this.requestedIds.add(t),this.loadContentInfo(e.id,e.type).then(o=>{if(o){this.memoryCache[t]=o,this.diskCache[t]=o,Lampa.Storage.set(ee,this.diskCache);return}})),this.diskCache[t]||null)}static loadContentInfo(e,t,o=!0){return r(this,null,function*(){let n=Lampa.Storage.field("tmdb_lang")||Lampa.Storage.field("language")||"ru",s=Lampa.Utils.addUrlComponent(Lampa.TMDB.api(`${t}/${e}?email=`),`api_key=${Lampa.TMDB.key()}&language=${n}&certification_country=ru&certification.lte=18`);try{let c=yield fetch(s);if(c.ok){let p=yield c.json();if(p!=null&&p.title||p!=null&&p.name)return p}else if(o){b(`Failed to load '${t}_${e}', status: ${c.status}. Trying fallback type.`);let p=t==="movie"?"tv":"movie";return yield this.loadContentInfo(e,p,!1)}}catch(c){X(`Failed to load ${t} info for id ${e}:`,c)}return null})}};h.requestedIds=new Set,h.diskCache=Lampa.Storage.get(ee,{}),h.memoryCache={};var l={STOPPED:0,CHECK_PENDING:1,CHECKING:2,DOWNLOAD_PENDING:3,DOWNLOADING:4,SEED_PENDING:5,SEEDING:6,ISOLATED:7,STALLED:8,ERROR:9,ALLOCATING:10,MOVING:11,UNKNOWN:12,INITIALIZATION:13};function te(a){switch(a){case 0:return l.STOPPED;case 1:return l.CHECK_PENDING;case 2:return l.CHECKING;case 3:return l.DOWNLOAD_PENDING;case 4:return l.DOWNLOADING;case 5:return l.SEED_PENDING;case 6:return l.SEEDING;default:return l.UNKNOWN}}function ae(a){switch(a){case"allocating":return l.ALLOCATING;case"checkingDL":case"checkingUP":case"checkingResumeData":return l.CHECKING;case"queuedDL":return l.DOWNLOAD_PENDING;case"queuedUP":return l.SEED_PENDING;case"downloading":case"forcedMetaDL":return l.DOWNLOADING;case"uploading":case"forcedUP":return l.SEEDING;case"pausedDL":case"pausedUP":case"stoppedDL":case"stoppedUP":return l.STOPPED;case"stalledDL":case"stalledUP":return l.STALLED;case"missingFiles":return l.ISOLATED;case"moving":return l.MOVING;case"error":return l.ERROR;case"metaDL":case"forcedDL":return l.INITIALIZATION;default:return l.UNKNOWN}}var oe="lampa:";function A(a){var o;let t=((o=(typeof a=="string"?a.split(",").map(n=>n.trim()):a).find(n=>n.startsWith(oe)))==null?void 0:o.split(":")[1])||"";return parseInt(t)}function E(a){return(typeof a=="string"?a.split(",").map(t=>t.trim()):a).indexOf("tv")!==-1?"tv":"movie"}function y(a){let e=[oe+a.id];return a.seasons&&e.push("tv"),e}var P=class{constructor(e,t,o,n){this.url=e;this.login=t;this.password=o;this.cookie=n}fetchWithAuth(o){return r(this,arguments,function*(e,t={}){let n=yield fetch(this.url+e,C(D({},t),{credentials:"include"}));return!n.ok&&n.status===403&&(yield this.authorize(),n=yield fetch(this.url+e,C(D({},t),{credentials:"include"}))),n})}authorize(){return r(this,null,function*(){let e=new URLSearchParams;e.append("username",this.login),e.append("password",this.password);let t=yield fetch(this.url+"/api/v2/auth/login",{method:"POST",body:e,credentials:"include"});if(!t.ok)throw new Error("qBittorrent login failed");this.cookie=t.headers.get("set-cookie")||void 0})}getTorrents(){return r(this,null,function*(){let e=yield this.fetchWithAuth("/api/v2/torrents/info");if(!e.ok)throw new Error("Failed to get torrents");let t=yield e.json();return this.formatTorrents(t)})}getData(){return r(this,null,function*(){var n;let e=yield this.fetchWithAuth("/api/v2/sync/maindata");if(!e.ok)throw new Error("Failed to get qBittorrent info");let t=yield e.json(),o=(n=t.torrents)!=null?n:[];return{torrents:this.formatTorrents(Array.isArray(o)?o:Object.keys(o).map(s=>C(D({},o[s]),{hash:s}))),info:{freeSpace:t.server_state.free_space_on_disk}}})}addTorrent(e,t){return r(this,null,function*(){let o=new FormData,n=new URL(t.MagnetUri||t.Link);if(n.searchParams.delete("dn"),o.append("urls",n.toString()),o.append("tags",y(e).join(",")),o.append("sequentialDownload","true"),!(yield this.fetchWithAuth("/api/v2/torrents/add",{method:"POST",body:o})).ok)throw new Error("Failed to add torrent")})}startTorrent(e){return r(this,null,function*(){let t=new URLSearchParams;if(t.append("hashes",String(e.externalId)),!(yield this.fetchWithAuth("/api/v2/torrents/start",{method:"POST",body:t})).ok)throw new Error("Failed to start torrents")})}stopTorrent(e){return r(this,null,function*(){let t=new URLSearchParams;if(t.append("hashes",String(e.externalId)),!(yield this.fetchWithAuth("/api/v2/torrents/stop",{method:"POST",body:t})).ok)throw new Error("Failed to stop torrents")})}hideTorrent(e){return r(this,null,function*(){let t=new URLSearchParams;if(t.append("hashes",String(e.externalId)),t.append("tags","hide"),!(yield this.fetchWithAuth("/api/v2/torrents/addTags",{method:"POST",body:t})).ok)throw new Error("Failed to hide torrent")})}removeTorrent(e,t=!1){return r(this,null,function*(){let o=new URLSearchParams;if(o.append("hashes",String(e.externalId)),o.append("deleteFiles",t?"true":"false"),!(yield this.fetchWithAuth("/api/v2/torrents/delete",{method:"POST",body:o})).ok)throw new Error("Failed to remove torrents")})}getFiles(e){return r(this,null,function*(){let t=new URLSearchParams;t.append("hash",String(e.externalId));let o=yield this.fetchWithAuth(`/api/v2/torrents/files?${t.toString()}`);if(!o.ok)throw new Error(`Failed to get files for torrent ${e.externalId}`);return(yield o.json()).map(s=>{var c,p;return{bytesCompleted:Math.floor(s.progress*s.size),length:s.size,name:s.name,begin_piece:(c=s.piece_range)==null?void 0:c[0],end_piece:(p=s.piece_range)==null?void 0:p[1]}})})}formatTorrents(e){return e.sort((t,o)=>o.added_on-t.added_on).filter(t=>!t.tags.includes("hide")).map(t=>({id:A(t.tags),type:E(t.tags),externalId:t.hash,name:t.name,status:ae(t.state),percentDone:t.progress,totalSize:t.size,eta:t.eta,speed:t.dlspeed,files:[],seeders:t.num_seeds,activeSeeders:t.num_complete,hash:t.hash}))}};var k=class{constructor(e,t,o,n){this.url=e;this.login=t;this.password=o;this.sessionId=n}POST(e){return r(this,null,function*(){let t=yield fetch(this.url,{method:"POST",headers:{Authorization:`Basic ${btoa(this.login+":"+this.password)}`,"Content-Type":"application/json","X-Transmission-Session-Id":this.sessionId||""},body:JSON.stringify(e)});if(t.status===409){if(this.sessionId=t.headers.get("X-Transmission-Session-Id"),this.sessionId==null)throw new Error("Can`t authorize to Transmission RPC");return this.POST(e)}if(!t.ok)throw{message:`Transmission RPC error: ${t.statusText}`,status:t.status};return yield t.json()})}getSession(){let e={method:"session-get"};return this.POST(e)}addTorrent(e){let t={method:"torrent-add",arguments:e};return this.POST(t)}getTorrents(e){let t={method:"torrent-get",arguments:e};return this.POST(t)}setTorrent(e){let t={method:"torrent-set",arguments:e};return this.POST(t)}startTorrent(e){let t={method:"torrent-start",arguments:e};return this.POST(t)}stopTorrent(e){let t={method:"torrent-stop",arguments:e};return this.POST(t)}removeTorrent(e){let t={method:"torrent-remove",arguments:e};return this.POST(t)}};var N=class{constructor(e,t,o){this.url=e;this.login=t;this.password=o;this.client=new k(e+"/transmission/rpc",t,o)}getTorrents(){return r(this,null,function*(){var t;return((t=(yield this.client.getTorrents({fields:["id","name","status","percentDone","sizeWhenDone","rateDownload","eta","labels","files","peersConnected","peersSendingToUs","trackerStats","hashString"]})).arguments)==null?void 0:t.torrents.filter(o=>!Array.isArray(o.labels)||o.labels.indexOf("hide")===-1).map(o=>{let n=0,s=0;return Array.isArray(o.trackerStats)&&(n=Math.max(...o.trackerStats.map(c=>c.seederCount||0),0)),s=o.peersSendingToUs||0,{id:A(o.labels),type:E(o.labels),externalId:o.id,name:o.name,status:te(o.status),percentDone:o.percentDone,totalSize:o.sizeWhenDone,eta:o.eta,speed:o.rateDownload,files:o.files,seeders:n,activeSeeders:s,hash:o.hashString}}).filter(o=>o.id))||[]})}addTorrent(e,t){return r(this,null,function*(){var n;let o=yield this.client.addTorrent({paused:!1,sequential_download:!0,filename:t.MagnetUri||t.Link,labels:y(e)});(n=o.arguments)!=null&&n["torrent-added"]&&(yield this.client.setTorrent({ids:[o.arguments["torrent-added"].id],labels:y(e)}))})}startTorrent(e){return r(this,null,function*(){yield this.client.startTorrent({ids:[e.externalId]})})}stopTorrent(e){return r(this,null,function*(){yield this.client.stopTorrent({ids:[e.externalId]})})}hideTorrent(e){return r(this,null,function*(){var n,s;let o=((s=(n=(yield this.client.getTorrents({ids:[e.externalId],fields:["labels"]})).arguments)==null?void 0:n.torrents[0])==null?void 0:s.labels)||[];yield this.client.setTorrent({ids:[e.externalId],labels:[...o,"hide"]})})}removeTorrent(e,t=!1){return r(this,null,function*(){yield this.client.removeTorrent({ids:[e.externalId],"delete-local-data":t})})}getFiles(e){return r(this,null,function*(){return e.files})}getData(){return r(this,null,function*(){return{torrents:yield this.getTorrents(),info:{freeSpace:0}}})}};var T=class T{static getClient(){if(!this.client){let e=Lampa.Storage.field(L),t=e.split(";");t.length===1&&T.buildClient(e),t.length>1&&T.selectUrl(t)}return this.client}static reset(){this.client=void 0}static buildClient(e){let t=Lampa.Storage.field(U)===1,o=Lampa.Storage.field(M),n=Lampa.Storage.field(z);this.client=t?new P(e,o,n):new N(e,o,n)}static selectUrl(e){return r(this,null,function*(){let t=e.map(o=>fetch(o+"/ping",{cache:"no-cache"}).then(n=>n.ok?o:Promise.reject()));return new Promise(o=>{let n=0,s=!1;t.forEach(c=>c.then(p=>{s||(s=!0,this.buildClient(p),o())}).catch(()=>{++n===t.length&&!s&&(this.buildClient(e[0]),o())}))})})}};T.isConnected=!1;var d=T;var F=`${i.component}.interval`,q=`${i.component}.default-action`,G=`${i.component}.allow-multiple-marks`,K=`${i.component}.poster-quality`,L=`${i.component}.server.url`,M=`${i.component}.server.login`,z=`${i.component}.server.password`,U=`${i.component}.server.type`,ne=[2,5,10,30,60,5*60,15*60],W=["w200","w342","w500","w780","w1280"];function re(){Lampa.SettingsApi.addComponent({component:i.component,name:i.name,icon:_}),Lampa.SettingsApi.addParam({component:i.component,param:{name:F,type:"select",placeholder:"2s",values:["2s","5s","10s","30s","1m","5m","15m"],default:0},field:{name:"Update interval"},onChange(a){Lampa.Settings.update(),w.start()}}),Lampa.SettingsApi.addParam({component:i.component,param:{name:q,type:"select",placeholder:"",values:["Open actions menu","Play","Resume / Pause download"],default:0},field:{name:"Default press action",description:"Long press always opens the actions menu."},onChange(a){Lampa.Settings.update()}}),Lampa.SettingsApi.addParam({component:i.component,param:{name:G,type:"trigger",default:!1},field:{name:"Keep torrents screen open after download",description:"After selecting a torrent, the app does not return back and keeps the add screen open, allowing you to add multiple torrents in a row."},onChange(a){Lampa.Settings.update()}}),Lampa.SettingsApi.addParam({component:i.component,param:{name:K,type:"select",placeholder:"",values:["Low","Medium","High","Very High","Ultra"],default:1},field:{name:"Poster quality"},onChange(a){Lampa.Settings.update()}}),Lampa.SettingsApi.addParam({component:i.component,param:{name:"transmission-title",type:"title",default:""},field:{name:"Server settings:"}}),Lampa.SettingsApi.addParam({component:i.component,param:{name:U,type:"select",placeholder:"",values:["Transmission","qBitTorrent"],default:"0"},field:{name:"Torrent Client"},onChange(a){Lampa.Settings.update(),d.reset()}}),Lampa.SettingsApi.addParam({component:i.component,param:{name:L,type:"input",placeholder:"",values:"",default:""},field:{name:"Url"},onChange(a){Lampa.Settings.update(),d.reset()}}),Lampa.SettingsApi.addParam({component:i.component,param:{name:M,type:"input",placeholder:"",values:"",default:""},field:{name:"Login"},onChange(a){Lampa.Settings.update(),d.reset()}}),Lampa.SettingsApi.addParam({component:i.component,param:{name:z,type:"input",placeholder:"",values:"",default:""},field:{name:"Password"},onChange(a){Lampa.Settings.update(),d.reset()}})}function S(a,e=2){if(a===0)return"0";let t=1024,o=e<0?0:e,n=Math.floor(Math.log(a)/Math.log(t));return parseFloat((a/Math.pow(t,n)).toFixed(o))+" "+Lampa.Lang.translate(`download-card.size.${n}`)}function Oe(a){let e=Lampa.Lang.translate("download-card.time.3");return`${S(a)}/${e}`}function Re(a){let e=Math.floor(a/86400),t=Math.floor(a%86400/3600),o=Math.floor(a%3600/60),n=Math.floor(a%60);return[e,t,o,n].map((c,p)=>c?c+Lampa.Lang.translate(`download-card.time.${p}`):null).filter(Boolean).slice(0,2).join(" ")}function $e(a){let e=new Date(a||"");return isNaN(e.getTime())?"":e.getFullYear()}function v(a){let e=h.getMovieInfo(a),t=W[Lampa.Storage.get(K)]||W[1];return{id:a.id+"_"+a.externalId,title:(e==null?void 0:e.title)||(e==null?void 0:e.name)||(a.status===l.INITIALIZATION?"Initialization":a.name),poster:e!=null&&e.poster_path?Lampa.TMDB.image(`t/p/${t}${e.poster_path}`):"",year:$e((e==null?void 0:e.release_date)||(e==null?void 0:e.first_air_date)),fileName:e!=null&&e.title||e!=null&&e.name?a.name:"",percent:(100*a.percentDone).toFixed(2)+"%",speed:a.speed>0?Oe(a.speed):"",downloadedSize:S(a.percentDone*a.totalSize),totalSize:S(a.totalSize),eta:a.status===l.DOWNLOADING?Re(a.eta):a.status===l.STALLED&&a.percentDone===1?Lampa.Lang.translate("download-card.status.14"):Lampa.Lang.translate(`download-card.status.${a.status}`),status:a.status===l.DOWNLOADING?"downloading":a.percentDone===1?"completed":"paused",seeders:`${a.seeders||0} (${a.activeSeeders||0})`}}var se=i.component+".torrents.data.views.",I=class a{static getViews(e){return Lampa.Storage.get(se+e.externalId)}static rememberView(e,t){let o=a.getViews(e)||{};o.last=t,o[t]=!0,Lampa.Storage.set(se+e.externalId,o)}};function ie(a,e,t){return r(this,null,function*(){let o=d.getClient(),n=yield o.getFiles(e),s=o.url+"/downloads/";if(n.length<1)throw new Error("No files found in torrent");if(n.length===1&&(Lampa.Player.play({title:t||e.name,url:s+n[0].name,torrent_hash:e.hash}),Lampa.Player.playlist([])),n.length>1){let R,c=I.getViews(e),u=n.sort((g,j)=>g.name.localeCompare(j.name,void 0,{numeric:!0,sensitivity:"base"})).map((g,j)=>({title:g.name.split(/[\\/]/).pop()||g.name,name:g.name,url:s+g.name,picked:c[g.name],selected:c.last===g.name,torrent_hash:e.hash}));Lampa.Select.show({title:Lampa.Lang.translate("actions.select-file"),items:u,onSelect(g){return r(this,null,function*(){I.rememberView(e,g.name),Lampa.Player.play({playlist:u,title:t||e.name,url:g.url,torrent_hash:e.hash}),Lampa.Player.playlist(u)})},onBack:function(){Lampa.Controller.toggle(a)}})}})}function le(a){a.status===l.STOPPED?d.getClient().startTorrent(a):d.getClient().stopTorrent(a)}function x(a,e,t){e=f.ensureMovie(e),Lampa.Select.show({title:Lampa.Lang.translate("actions.title"),items:[{title:Lampa.Lang.translate("actions.open"),onSelect(){return r(this,null,function*(){ie(a,e,t)})}},...a==="downloads-tab"&&e.id?[{title:Lampa.Lang.translate("actions.open-card"),onSelect(){return r(this,null,function*(){Lampa.Activity.push({component:"full",id:e.id,method:e.type,card:e})})}}]:[],{title:e.status===l.STOPPED?Lampa.Lang.translate("actions.resume"):Lampa.Lang.translate("actions.pause"),onSelect(){le(e),Lampa.Controller.toggle(a)}},{title:Lampa.Lang.translate("actions.hide"),onSelect(){d.getClient().hideTorrent(e),$(`.downloads-tab__item[data-id="${e.id}_${e.externalId}"]`).remove(),Lampa.Controller.toggle(a)}},{title:Lampa.Lang.translate("actions.delete"),subtitle:Lampa.Lang.translate("actions.delete-with-file"),onSelect(){d.getClient().removeTorrent(e,!0),$(`.downloads-tab__item[data-id="${e.id}_${e.externalId}"]`).remove(),Lampa.Controller.toggle(a)}},{title:Lampa.Lang.translate("actions.delete-torrent"),subtitle:Lampa.Lang.translate("actions.delete-torrent-keep-file"),onSelect(){d.getClient().removeTorrent(e,!1),$(`.downloads-tab__item[data-id="${e.id}_${e.externalId}"]`).remove(),Lampa.Controller.toggle(a)}}],onBack:function(){Lampa.Controller.toggle(a)}})}function O(a,e,t){let o=Lampa.Storage.field(q);o==1?ie(a,e,t):o==2?le(e):x(a,e,t)}function Y(a,e){let t=$(Lampa.Template.get("download-card",v(a)));$(".full-start-new__right").append(t),t.on("hover:enter",()=>{O("full_start",a,(e==null?void 0:e.title)||(e==null?void 0:e.original_title))}),t.on("hover:long",()=>{x("full_start",a,(e==null?void 0:e.title)||(e==null?void 0:e.original_title))})}function de(a){let e=v(a),t=document.getElementById(`download-card-${e.id}`);if(t){for(let o in e){let n=t.querySelector(`[data-key="${o}"]`);n&&(n.textContent=e[o])}t.querySelector(".download-card__progress-bar-progress").setAttribute("style",`width: ${e.percent};`)}}function ce(){Lampa.Template.add("download-card",Z),$("body").append(`<style>${J}</style>`),Lampa.Listener.follow("full",a=>{if(a.type==="complite"){let e=f.getMovie(a.data.movie.id);e&&Y(e,a.data.movie)}})}var pe=`<div class="download-circle d-updatable download-circle-{status}-{id}">\r
...
}`;function ue(a,e){let t=$(e);if(!t.find(".download-circle").length){let o=Lampa.Template.get("download-circle",{id:a.id,status:a.percentDone===1?"complete":"in-progress",progress:100*(1-a.percentDone)});t.find(".card__vote").after(o)}}function ze(a,e){let t=f.getMovie(a);t&&ue(t,e)}function fe(a){let e=document.querySelectorAll(`.download-circle-in-progress-${a.id}`);e.length&&e.forEach(t=>{if(a.percentDone===1){let o=t.parentElement;t.remove(),ue(a,o)}else{let o=t.querySelector(".download-circle__partial_in-progress");o==null||o.setAttribute("stroke-dashoffset",`${100*(1-a.percentDone)}`)}})}function ge(){Lampa.Template.add("download-circle",pe),$("body").append(`<style>${me}</style>`),Lampa.Listener.follow("line",a=>{var e,t;if(a.type==="append")for(let o of a.items)(e=o==null?void 0:o.data)!=null&&e.id&&ze((t=o==null?void 0:o.data)==null?void 0:t.id,o.card)})}var m=class m{static start(){let e=ne[Lampa.Storage.field(F)];m.subscription&&clearInterval(m.subscription),m.errorCount=0,m.notified=!1,m.subscription=setInterval(m.tick,e*1e3)}static tick(){return r(this,null,function*(){try{let e=yield d.getClient().getData();if(f.setData(e),$(".d-updatable").length)for(let o of e.torrents)de(o),fe(o),we(o);let t=d.getClient().url;d.isConnected||b("Connected to "+t),d.isConnected=!0,m.notifyFirstTime(Lampa.Lang.translate("background-worker.connection-success")+": "+t)}catch(e){b("Error:",e),d.isConnected=!1,m.errorCount++,m.errorCount>10&&(clearInterval(m.subscription),b("Stopping background worker due to too many errors"),m.notifyFirstTime(Lampa.Lang.translate("background-worker.error-detected")))}})}static notifyFirstTime(e){m.notified||(Lampa.Noty.show(e),m.notified=!0)}};m.errorCount=0,m.notified=!1;var w=m;var he=`<div class="downloads-tab__item selector {status}" data-id="{id}">
...
`;var _e=`<div class="downloads-tab__list d-updatable">\r
