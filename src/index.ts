...
(function () {
    ...
    function getHeaders$2(type) {
        ...
        if (Lampa.Storage.get("lmetorrentqBittorentKey"))
            headers["set-cookie"] = Lampa.Storage.get(
        ...
        return new Promise(function (resolve, reject) {
            $.ajax(settings)
                .done(function (response) {
                    try {
                        var standardizedResponse = response.map(function (
                            torrent
                        ) {
                            return {
                                name: torrent.name,
                                ...
                                size: torrent.size,
                                state:
                                    torrent.state.charAt(0).toUpperCase() +
        ...
        var settings = {
            ...
            data: {
                ...
                category: selectedTorrent.CategoryDesc
                    ? Lampa.Storage.get(
                          "lmetorrentqBittorent".concat(
                              selectedTorrent.CategoryDesc
                          )
                      )
                    : "",
                firstLastPiecePrio: Lampa.Storage.field(
                    "lmetorrentqBittorentfirstLastPiecePrio"
                )
                    ? "true"
                    : "false",
                sequentialDownload: Lampa.Storage.field(
                    "lmetorrentqBittorentSequentialDownload"
                )
                    ? "true"
                    : "false",
            },
    ...
    function auth() {
        $.ajax({
            url: ""
                ...
                .concat(
                    url,
                    "/webapi/auth.cgi?api=SYNO.API.Auth&method=login&account="
                )
                .concat(user, "&passwd=")
                .concat(
                    pass,
                    "&format=sid&version=7&session=LMETorrentManager"
                ),
            method: "GET",
            headers: getHeaders(),
    ...
    function GetData() {
        var settings = {
            url: ""
                ...
                .concat(
                    url,
                    "/webapi/DownloadStation/task.cgi?api=SYNO.DownloadStation.Task&version=3&method=list&additional=file,transfer&_sid="
                )
                .concat(
                    Lampa.Storage.field("lmetorrentsynologyKey").sID,
                    "&limit=-1"
                ),
            method: "GET",
            timeout: 0,
        ...
        return new Promise(function (resolve, reject) {
            $.ajax(settings)
                .done(function (response) {
                    ...
                    try {
                        var standardizedResponse = response.data.tasks.map(
                            function (torrent) {
                                return {
                                    name: torrent.title,
                                    id: torrent.id,
                                    size: torrent.size,
                                    state:
                                        torrent.status.charAt(0).toUpperCase() +
                                        torrent.status.slice(1),
                                    completed:
                                        torrent.additional.transfer
    ...
    function SendCommand(a, torrent_data) {
        var settings = {
            url: ""
                ...
                .concat(
                    url,
                    "/webapi/DownloadStation/task.cgi?api=SYNO.DownloadStation.Task&version=1&method="
                )
                .concat(a.action, "&id=")
    ...
    function SendTask(selectedTorrent) {
        ...
        var settings = {
            url: ""
                ...
                .concat(
                    url,
                    "/webapi/DownloadStation/task.cgi?api=SYNO.DownloadStation.Task&version=1&method=create&uri="
                )
                .concat(
                    encodeURIComponent(
                        selectedTorrent.MagnetUri
    ...
    var regexp2 =
        /(?:PPV.)?[HP]DTV|(?:HD)?TC|[cC]am|(?:HD)?CAM|B[rR]Rip|WEBRip|WEB-Rip|WEB-DL|WEB|TS|(?:PPV )?WEB-?DL(?: DVDRip)?|H[dD]Rip|DVDRip|DVDRiP|DVDRIP|CamRip|W[EB]B[rR]ip|HDRIP|[Bb]lu[Rr]ay|DvDScr|hdtv/;
    function Item(data) {
    ...
    function Component() {
        ...
        var body = $(
            '<div class="lmetorrent-catalog--list category-full"></div>'
        );
        var active, last;
        ...
        this.errorClient = function (data) {
            ...
            var error_body =
                '<div class="lmetorrent-error_body">\n            <div>'
                    .concat(
                        Lampa.Lang.translate("somethingWentWrong"),
                                                            ...
                                                            onSelect:
                                                                function onSelect(
                                                                    ...
                                                                    switch (
                                                                        ...
                                                                        case "qBittorent":
                                                                            return Qbittorent.SendCommand(
                                                                                a,
                                                                                torrent_data
                                                                            );
                                                                        case "transmission":
                                                                            return Transmission.SendCommand(
                                                                                a,
                                                                                torrent_data
                                                                            );
                                                                        case "synology":
                                                                            return Synology.SendCommand(
                                                                                a,
                                                                                torrent_data
                                                                            );
                                                                        default:
    ...
    function Main$1(manifest) {
        ...
        Lampa.SettingsApi.addParam({
            ...
            onRender: function onRender(item) {
                if (
                    Lampa.Storage.field(manifest.component + "Select") ===
                    "universalClient"
                ) {
                    item.show();
                } else item.hide();
            ...
            onRender: function onRender(item) {
                if (
                    Lampa.Storage.field(manifest.component + "Select") ===
                        "qBittorent" &&
                    Lampa.Storage.field(
                        manifest.component + "qBittorentTweak"
                    ) === true
                ) {
                    item.show();
                } else item.hide();
            ...
            onRender: function onRender(item) {
                if (
                    Lampa.Storage.field(manifest.component + "Select") ===
                        "transmission" &&
                    Lampa.Storage.field(
                        manifest.component + "transmissionTweak"
                    ) === true
                ) {
                    item.show();
                } else item.hide();
    ...
    function Send() {
        ...
        Lampa.Listener.follow("torrent", function (e) {
            if (e.type === "onlong") {
                ...
                if (
                    Lampa.Storage.field("lmetorrentSelect") === "transmission"
                ) {
                    e.menu.push({
                        title: '<div class="btnTDdownload wait">\n                            <svg class="btnTDdownload" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M8.5 7L8.5 14M8.5 14L11 11M8.5 14L6 11" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M15.5 7L15.5 14M15.5 14L18 11M15.5 14L13 11" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M18 17H12H6" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="#ffffff" stroke-width="1.5"></path> </g></svg>\n                            Transmission</div>',
                ...
                //Universal
                if (
                    Lampa.Storage.field("lmetorrentSelect") ===
                    "universalClient"
                ) {
                    e.menu.push({
                        title: '<div class="btnTDdownload wait">\n                            <svg class="btnTDdownload" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M8.5 7L8.5 14M8.5 14L11 11M8.5 14L6 11" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M15.5 7L15.5 14M15.5 14L18 11M15.5 14L13 11" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M18 17H12H6" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="#ffffff" stroke-width="1.5"></path> </g></svg>\n                            Universal</div>',
    ...
    function add() {
        ...
        if (
            Lampa.Storage.get(manifest.component + "Select") !==
            "universalClient"
        )
        ...
        if (Lampa.Storage.get(manifest.component + "Select") === "synology") {
            ...
            if (
                isKeyDateOld(
                    Lampa.Storage.field("lmetorrentsynologyKey").createDate
                )
            ) {
                Synology.auth();
            }
